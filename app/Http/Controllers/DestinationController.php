...
class DestinationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('submenu.destinations.index', compact('destinations', 'countries'));
    }
    ...
    public function create()
    {
        ...
        return view('submenu.destinations.create', compact('countries'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('submenu.destinations.index')
    ...
    public function show(Destination $destination)
    {
        ...
        return view('submenu.destinations.show', compact('destination', 'statistics', 'recentShipments'));
    }
    ...
    public function edit(Destination $destination)
    {
        ...
        return view('submenu.destinations.edit', compact('destination', 'countries'));
    }
    ...
    public function update(Request $request, Destination $destination)
    {
        ...
        try {
            ...
            return redirect()->route('submenu.destinations.show', $destination)
