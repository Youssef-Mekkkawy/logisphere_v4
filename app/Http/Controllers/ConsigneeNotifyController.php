...
class ConsigneeNotifyController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('submenu.consignee-notify.index', compact('parties', 'countries'));
    }
    ...
    public function create()
    {
        ...
        return view('submenu.consignee-notify.create', compact('countries'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('submenu.consignee-notify.index')
    ...
    public function show(ConsigneeNotify $consigneeNotify)
    {
        ...
        return view('submenu.consignee-notify.show', compact('consigneeNotify', 'statistics', 'recentShipments'));
    }
    ...
    public function edit(ConsigneeNotify $consigneeNotify)
    {
        ...
        return view('submenu.consignee-notify.edit', compact('consigneeNotify', 'countries'));
    }
    ...
    public function update(Request $request, ConsigneeNotify $consigneeNotify)
    {
        ...
        try {
            ...
            return redirect()->route('submenu.consignee-notify.show', $consigneeNotify)
