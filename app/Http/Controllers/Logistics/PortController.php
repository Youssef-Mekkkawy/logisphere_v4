...
class PortController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware('permission:ports.view')->only(['index', 'show']);
    ...
    public function index(Request $request)
    {
        ...
        return view('logistics.ports.index', compact('ports', 'countries'));
    }
    ...
    public function create()
    {
        ...
        return view('logistics.ports.create', compact('countries'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('logistics.ports.index')
    ...
    public function show(Port $port)
    {
        ...
        return view('logistics.ports.show', compact('port', 'statistics', 'recentShipments'));
    }
    ...
    public function edit(Port $port)
    {
        ...
        return view('logistics.ports.edit', compact('port', 'countries'));
    }
    ...
    public function update(Request $request, Port $port)
    {
        ...
        try {
            ...
            return redirect()->route('logistics.ports.show', $port)
