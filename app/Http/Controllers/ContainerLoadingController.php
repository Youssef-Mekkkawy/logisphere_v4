...
class ContainerLoadingController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('submenu.container-loading.index', compact('loadingPoints', 'countries'));
    }
    ...
    public function create()
    {
        ...
        return view('submenu.container-loading.create', compact('countries'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('submenu.container-loading.index')
    ...
    public function show(ContainerLoading $containerLoading)
    {
        ...
        return view('submenu.container-loading.show', compact('containerLoading', 'statistics', 'recentBookings'));
    }
    ...
    public function edit(ContainerLoading $containerLoading)
    {
        ...
        return view('submenu.container-loading.edit', compact('containerLoading', 'countries'));
    }
    ...
    public function update(Request $request, ContainerLoading $containerLoading)
    {
        ...
        try {
            ...
            return redirect()->route('submenu.container-loading.show', $containerLoading)
