...
class CompanyController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('companies.create', compact('serviceTypes', 'countries'));
    }
    ...
    public function show(Company $company)
    {
        ...
        return view('companies.show', compact('company', 'statistics', 'monthlyTrends'));
    }
    ...
    public function edit(Company $company)
    {
        ...
        return view('companies.edit', compact('company', 'serviceTypes', 'countries'));
    }
    ...
    public function performance(Company $company)
    {
        ...
        return view('companies.performance', compact('company', 'performanceData'));
    }
    ...
    public function shipments(Company $company, Request $request)
    {
        ...
        return view('companies.shipments', compact('company', 'shipments', 'statuses'));
    }
