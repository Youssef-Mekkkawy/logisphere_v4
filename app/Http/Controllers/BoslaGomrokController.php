...
class BoslaGomrokController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('submenu.bosla-gomrok.index', compact('boslaItems', 'customsOffices'));
    }
    ...
    public function create()
    {
        ...
        return view('submenu.bosla-gomrok.create', compact('customsOffices'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('submenu.bosla-gomrok.index')
    ...
    public function show(BoslaGomrok $boslaGomrok)
    {
        ...
        return view('submenu.bosla-gomrok.show', compact('boslaGomrok', 'statistics', 'recentUsage'));
    }
    ...
    public function edit(BoslaGomrok $boslaGomrok)
    {
        ...
        return view('submenu.bosla-gomrok.edit', compact('boslaGomrok', 'customsOffices'));
    }
    ...
    public function update(Request $request, BoslaGomrok $boslaGomrok)
    {
        ...
        return redirect()->route('submenu.bosla-gomrok.show', $boslaGomrok)
