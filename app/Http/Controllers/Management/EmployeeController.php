...
class EmployeeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $user = User::create([
            ...
            'password' => bcrypt('password'), // you can generate random
        ...
        try {
            ...
            // dd($employee->name, $employee->department, $employee->id);

            // dd();
            return redirect()->route('management.employees.show', $employee, $user)
