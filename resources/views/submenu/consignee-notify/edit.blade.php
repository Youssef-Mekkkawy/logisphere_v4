...
@section('content')
    ...
    <form action="{{ route('submenu.consignee-notify.update', $consigneeNotify) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div style="display: flex; gap: 1rem; justify-content: flex-end;">
            <a href="{{ route('submenu.consignee-notify.show', $consigneeNotify) }}" class="btn btn-secondary">Cancel</a>
