...
@section('content')
    ...
    <form action="{{ route('submenu.inspection-types.update', $inspectionType) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div style="display: flex; gap: 1rem; justify-content: flex-end;">
            <a href="{{ route('submenu.inspection-types.show', $inspectionType) }}" class="btn btn-secondary">Cancel</a>
