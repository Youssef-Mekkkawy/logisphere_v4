    ...
    <div style="margin-bottom: 2rem;">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <div style="display: flex; gap: 1rem;">
                <a href="{{ route('submenu.inspection-types.edit', $inspectionType) }}" class="btn btn-primary">Edit
                    Inspection Type</a>
                <a href="{{ route('submenu.inspection-types.index') }}" class="btn btn-secondary">Back to List</a>
            </div>
        </div>
    </div>
