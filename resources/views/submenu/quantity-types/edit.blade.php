...
@section('title', 'Edit Quantity Type - ' . $quantityType->quantity_name)
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 text-gray-800 mb-0">
                    <i class="fas fa-edit text-primary me-2"></i>Edit Quantity Type
                </h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{{ route('submenu.quantity-types.show', $quantityType) }}">{{ $quantityType->quantity_code }}</a>
                        </li>
            ...
            <div>
                <a href="{{ route('submenu.quantity-types.show', $quantityType) }}" class="btn btn-outline-secondary">
                    <i class="fas fa-times me-1"></i>Cancel
                </a>
            </div>
        </div>

        <form action="{{ route('submenu.quantity-types.update', $quantityType) }}" method="POST" id="quantityTypeForm">
            @csrf
            @method('PUT')
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            id="quantity_code" name="quantity_code"
                                            value="{{ old('quantity_code', $quantityType->quantity_code) }}" maxlength="20"
                                            style="text-transform: uppercase" required>
                                        @error('quantity_code')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        <small class="form-text text-muted">Unique quantity type identifier</small>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            id="quantity_name" name="quantity_name"
                                            value="{{ old('quantity_name', $quantityType->quantity_name) }}" required>
                                        @error('quantity_name')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('quantity_category') is-invalid @enderror"
                                            ...
                                            <option value="Weight"
                                                {{ old('quantity_category', $quantityType->quantity_category) == 'Weight' ? 'selected' : '' }}>
                                                ⚖️ Weight</option>
                                            <option value="Volume"
                                                {{ old('quantity_category', $quantityType->quantity_category) == 'Volume' ? 'selected' : '' }}>
                                                📦 Volume</option>
                                            <option value="Count"
                                                {{ old('quantity_category', $quantityType->quantity_category) == 'Count' ? 'selected' : '' }}>
                                                🔢 Count</option>
                                            <option value="Dimension"
                                                {{ old('quantity_category', $quantityType->quantity_category) == 'Dimension' ? 'selected' : '' }}>
                                                📏 Dimension</option>
                                            <option value="Container"
                                                {{ old('quantity_category', $quantityType->quantity_category) == 'Container' ? 'selected' : '' }}>
                                                🚛 Container</option>
                                            <option value="Liquid"
                                                {{ old('quantity_category', $quantityType->quantity_category) == 'Liquid' ? 'selected' : '' }}>
                                                💧 Liquid</option>
                                            <option value="Area"
                                                {{ old('quantity_category', $quantityType->quantity_category) == 'Area' ? 'selected' : '' }}>
                                                📐 Area</option>
                                            <option value="Time"
                                                {{ old('quantity_category', $quantityType->quantity_category) == 'Time' ? 'selected' : '' }}>
                                                ⏰ Time</option>
                                            <option value="Custom"
                                                {{ old('quantity_category', $quantityType->quantity_category) == 'Custom' ? 'selected' : '' }}>
                                                ⚙️ Custom</option>
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('unit_of_measure', $quantityType->unit_of_measure) }}" required>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            name="unit_symbol" value="{{ old('unit_symbol', $quantityType->unit_symbol) }}"
                                            maxlength="20" placeholder="e.g., kg, m³, TEU">
                                        @error('unit_symbol')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                    rows="3" placeholder="Detailed description of this quantity type">{{ old('description', $quantityType->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            name="base_unit" value="{{ old('base_unit', $quantityType->base_unit) }}"
                                            list="baseUnitsList" placeholder="e.g., kg, liters">
                                        ...
                                        @error('base_unit')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        <small class="form-text text-muted">For unit conversions</small>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number"
                                            ...
                                            value="{{ old('conversion_factor', $quantityType->conversion_factor) }}"
                                            step="0.000001" min="0" placeholder="1.0">
                                        @error('conversion_factor')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        <small class="form-text text-muted">Multiplier to base unit</small>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number"
                                            ...
                                            value="{{ old('decimal_places', $quantityType->decimal_places) }}"
                                            min="0" max="10" placeholder="2">
                                        @error('decimal_places')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        <small class="form-text text-muted">Display precision</small>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('calculation_method') is-invalid @enderror" id="calculation_method"
                                            name="calculation_method" rows="2" placeholder="How is this quantity calculated?">{{ old('calculation_method', $quantityType->calculation_method) }}</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        @error('display_format')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        <small class="form-text text-muted">printf format string</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <div class="cargo-types-container" id="cargoTypesContainer">
                                    @if (old('applicable_cargo_types', $quantityType->applicable_cargo_types))
                                        @foreach (old('applicable_cargo_types', $quantityType->applicable_cargo_types) as $index => $cargoType)
                                            <div class="input-group mb-2">
                                                <input type="text" name="applicable_cargo_types[]"
                                                    class="form-control" value="{{ $cargoType }}"
                                ...
                                <div class="form-text">
                                    <small>Leave empty to allow all cargo types</small>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="standards-container" id="standardsContainer">
                                            @if (old('industry_standards', $quantityType->industry_standards))
                                                @foreach (old('industry_standards', $quantityType->industry_standards) as $index => $standard)
                                                    <div class="input-group mb-2">
                                                        <input type="text" name="industry_standards[]"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="validation-container" id="validationContainer">
                                            @if (old('validation_rules', $quantityType->validation_rules))
                                                @foreach (old('validation_rules', $quantityType->validation_rules) as $index => $rule)
                                                    <div class="input-group mb-2">
                                                        <input type="text" name="validation_rules[]"
                                                            class="form-control" value="{{ $rule }}"
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="range_min"
                                            name="common_ranges[min]"
                                            value="{{ old('common_ranges.min', $quantityType->common_ranges['min'] ?? '') }}"
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="range_max"
                                            name="common_ranges[max]"
                                            value="{{ old('common_ranges.max', $quantityType->common_ranges['max'] ?? '') }}"
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            list="reportingCategoriesList" placeholder="e.g., Gross Weight">
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            id="customs_code" name="customs_code"
                                            value="{{ old('customs_code', $quantityType->customs_code) }}" maxlength="50"
                                            placeholder="HS/customs code">
                                        @error('customs_code')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('notes') is-invalid @enderror" id="notes" name="notes" rows="4"
                                    placeholder="Additional information about this quantity type">{{ old('notes', $quantityType->notes) }}</textarea>
                                @error('notes')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('sort_order') is-invalid @enderror"
                                    ...
                                    value="{{ old('sort_order', $quantityType->sort_order ?? 0) }}" min="0">
                                @error('sort_order')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-check mb-3">
                                <input class="form-check-input" type="checkbox" id="is_active" name="is_active"
                                    value="1" {{ old('is_active', $quantityType->is_active) ? 'checked' : '' }}>
                        ...
                        <div class="card-body">
                            <div class="form-check mb-3">
                                <input class="form-check-input" type="checkbox" id="is_standard" name="is_standard"
                                    value="1" {{ old('is_standard', $quantityType->is_standard) ? 'checked' : '' }}>
                        ...
                        <div class="card-body">
                            <div class="form-check mb-3">
                                <input class="form-check-input" type="checkbox" id="is_billable" name="is_billable"
                                    value="1" {{ old('is_billable', $quantityType->is_billable) ? 'checked' : '' }}>
                                <label class="form-check-label" for="is_billable">💰 Billable Unit</label>
                            </div>

                            <div id="billingOptions"
                                class="{{ old('is_billable', $quantityType->is_billable) ? '' : 'd-none' }}">
                                <div class="mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ old('billing_multiplier', $quantityType->billing_multiplier) }}"
                                        step="0.0001" min="0" placeholder="1.0">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ old('minimum_chargeable', $quantityType->minimum_chargeable) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="rounding_method" name="rounding_method">
                                        <option value="nearest"
                                            {{ old('rounding_method', $quantityType->rounding_method) == 'nearest' ? 'selected' : '' }}>
                                            Round to Nearest</option>
                                        <option value="up"
                                            {{ old('rounding_method', $quantityType->rounding_method) == 'up' ? 'selected' : '' }}>
                                            Round Up (Ceiling)</option>
                                        <option value="down"
                                            {{ old('rounding_method', $quantityType->rounding_method) == 'down' ? 'selected' : '' }}>
                        ...
                        <div class="card-body">
                            <div class="d-grid gap-2">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save me-1"></i>Update Quantity Type
                                </button>
                            ...
                            <div class="text-center">
                                <small class="text-muted">
                                    Last updated: {{ $quantityType->updated_at->format('M d, Y H:i') }}
                                </small>
                            </div>
                        </div>
                    </div>
...
@push('scripts')
    ...
    `;
        ...
        document.addEventListener('DOMContentLoaded', function() {
            if (document.getElementById('cargoTypesContainer').children.length === 0) {
                addCargoType();
            }
            if (document.getElementById('standardsContainer').children.length === 0) {
                addStandard();
            }
            if (document.getElementById('validationContainer').children.length === 0) {
                addValidation();
            }
        });
        ...
        document.getElementById('quantityTypeForm').addEventListener('submit', function(e) {
            const requiredFields = ['quantity_code', 'quantity_name', 'quantity_category', 'unit_of_measure'];
            let isValid = true;
