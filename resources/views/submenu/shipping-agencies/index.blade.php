        ...
        <div class="card-body">
            <form method="GET"
                ...
                <div>
                    ...
                    <a href="{{ route('shipping-agencies.index') ?? '' }}" class="btn btn-secondary"
                    ...
                    @forelse($agencies as $agency)
                        <tr>
                            ...
                            <td style="display: flex; gap: 0.5rem;">
                                <a href="{{ route('submenu.shipping-agencies.show' ?? '', $agency) }}"
                                    class="btn btn-outline" style="padding: 0.25rem 0.5rem; font-size: 0.75rem;">View</a>
                                <a href="{{ route('submenu.shipping-agencies.edit' ?? '', $agency) }}"
                                ...
                                @if (auth()->user() && method_exists(auth()->user(), 'isAdmin') && auth()->user()->isAdmin())
                                    <form action="{{ route('submenu.shipping-agencies.destroy' ?? '', $agency) }}"
