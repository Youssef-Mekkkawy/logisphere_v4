...
<div id="client-companies-tab" class="tab-content active">
    ...
    <a href="{{ route('companies.create') }}" class="btn btn-primary">Add New Client</a>
        ...
        <tbody>
            ...
            <tr>
                <td colspan="7" style="text-align: center; padding: 40px;">
                    <p style="color: #6b7280;">No client companies found. <a href="{{ route('companies.create') }}">Add your first client</a></p>
                </td>
            </tr>
            @endforelse
        </tbody>
...
<div id="supplier-companies-tab" class="tab-content">
    ...
    <a href="{{ route('companies.create') }}" class="btn btn-primary">Add New Supplier</a>
        ...
        <tbody>
            ...
            <tr>
                <td colspan="6" style="text-align: center; padding: 40px;">
                    <p style="color: #6b7280;">No supplier companies found. <a href="{{ route('companies.create') }}">Add your first supplier</a></p>
                </td>
            </tr>
            @endforelse
        </tbody>
