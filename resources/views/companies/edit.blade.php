...
<form method="POST" action="{{ route('companies.update', $company) }}"
    ...
    <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #e5e7eb;">
        ...
        <a href="{{ route('companies.show', $company) }}" class="btn btn-secondary" style="margin-left: 15px;">
...
<!-- Hidden Delete Form -->
@if(auth()->user()->isAdmin() && in_array($company->status, ['Inactive']))
<form id="delete-form" method="POST" action="{{ route('companies.destroy', $company) }}" style="display: none;">
    @csrf
    @method('DELETE')
</form>
@endif
