        ...
        <div style="background: white; border-radius: 15px; padding: 30px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.08);">
            ...
            @if($company->shipments->count() > 0)
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('shipments.show', $shipment) }}" class="btn btn-primary" style="padding: 5px 10px; font-size: 12px;">View</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
                ...
                @if($company->shipments->count() > 10)
                    <p style="text-align: center; margin-top: 15px;">
                        <a href="{{ route('shipments.index', ['company' => $company->id]) }}" class="btn btn-primary">
            ...
            @else
                <p style="text-align: center; color: #6b7280; padding: 40px;">
                    ...
                    <br><br>
                    <a href="{{ route('shipments.create', ['company_id' => $company->id]) }}" class="btn btn-primary">
    ...
    <div>
        ...
        <div style="background: white; border-radius: 15px; padding: 20px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.08);">
            ...
            <div style="display: flex; flex-direction: column; gap: 10px;">
                <a href="{{ route('companies.edit', $company) }}" class="btn btn-primary" style="text-align: center;">
                    Edit Company
                </a>
                
                <a href="{{ route('shipments.create', ['company_id' => $company->id]) }}" class="btn btn-secondary" style="text-align: center;">
                    Create Shipment
                </a>
                ...
                <form method="POST" action="{{ route('companies.destroy', $company) }}" style="margin-top: 10px;">
                    @csrf
                    @method('DELETE')
