    ...
    <div>
        ...
        <div style="background: white; border-radius: 15px; padding: 20px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.08);">
            ...
            <div style="display: flex; flex-direction: column; gap: 10px;">
                <a href="{{ route('management.employees.edit', $employee) }}" class="btn btn-primary" style="text-align: center;">
                    Edit Employee
                </a>
                ...
                <form method="POST" action="{{ route('management.employees.destroy', $employee) }}" style="margin-top: 10px;">
                    @csrf
                    @method('DELETE')
