...
@section('content')
    ...
    <div
        ...
        <form method="GET" action="{{ route('management.employees.index') }}"
            ...
            <div style="display: flex; gap: 10px;">
                ...
                @if (request()->hasAny(['search', 'department', 'status']))
                    <a href="{{ route('management.employees.index') }}" class="btn btn-secondary">Clear</a>
                @endif
            </div>
        </form>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="display: flex; gap: 8px;">
                                    <a href="{{ route('management.employees.show', $employee) }}" class="btn btn-primary"
                                        style="padding: 6px 12px; font-size: 14px;">
                                        View
                                    </a>
                                    <a href="{{ route('management.employees.edit', $employee) }}" class="btn btn-secondary"
                                        style="padding: 6px 12px; font-size: 14px;">
                                        Edit
                                    </a>
                                </div>
                                    ...
                                    <p style="margin: 0;">
                                        @if (request()->hasAny(['search', 'department', 'status']))
                                            No employees match your current filters. <a
                                                href="{{ route('management.employees.index') }}">Clear filters</a> or
                                        @endif
                                        <a href="{{ route('management.employees.create') }}">add your first employee</a>
                                    </p>
                                </div>
                            </td>
                        </tr>
    ...
    <script>
        ...
        document.addEventListener('keydown', function(e) {
            if (e.ctrlKey && e.key === 'n') {
                e.preventDefault();
                window.location.href = "{{ route('management.employees.create') }}";
            }
        });
