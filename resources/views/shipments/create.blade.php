...
<div style="margin-top: 30px; padding: 20px; background: #fef3c7; border: 1px solid #f59e0b; border-radius: 10px; color: #92400e;">
    ...
    <ul style="margin: 0; padding-left: 20px;">
        @if($companies->isEmpty())
            <li>At least one company. <a href="{{ route('companies.create') }}" style="color: #1e40af;">Create a company</a></li>
        @endif
        @if($ports->isEmpty())
            <li>At least two ports. <a href="{{ route('submenu.ports') }}" style="color: #1e40af;">Manage ports</a></li>
        @endif
    </ul>
</div>
@endif
