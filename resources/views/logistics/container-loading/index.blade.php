...
@section('content')
    <div style="margin-bottom: 2rem;">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <a href="{{ route('logistics.container-loading.create') }}" class="btn btn-primary">+ Add New Loading Point</a>
        </div>
    </div>
        ...
        <div class="card-body">
            <form method="GET"
                ...
                <div>
                    ...
                    <a href="{{ route('logistics.container-loading.index') }}" class="btn btn-secondary"
                    ...
                    @forelse($loadingPoints as $point)
                        <tr>
                            ...
                            <td style="display: flex; gap: 0.5rem;">
                                <a href="{{ route('logistics.container-loading.show', $point) }}" class="btn btn-outline"
                                    style="padding: 0.25rem 0.5rem; font-size: 0.75rem;">View</a>
                                <a href="{{ route('logistics.container-loading.edit', $point) }}" class="btn btn-success"
                                    style="padding: 0.25rem 0.5rem; font-size: 0.75rem;">Edit</a>
                                @if (auth()->user()->isAdmin())
                                    <form action="{{ route('logistics.container-loading.destroy', $point) }}" method="POST"
                        ...
                        <tr>
                            <td colspan="9" style="text-align: center; padding: 2rem; color: #64748b;">
                                No container loading points found. <a
                                    href="{{ route('logistics.container-loading.create') }}"
