    ...
    <div style="margin-bottom: 2rem;">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <div style="display: flex; gap: 1rem;">
                <a href="{{ route('logistics.container-loading.edit', $containerLoading) }}" class="btn btn-primary">Edit
                    Loading Point</a>
                <a href="{{ route('logistics.container-loading.index') }}" class="btn btn-secondary">Back to List</a>
            </div>
        </div>
    </div>
                        ...
                        <tbody>
                            @foreach ($recentBookings as $booking)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('management.shipments.show', $booking) }}" class="btn btn-outline"
