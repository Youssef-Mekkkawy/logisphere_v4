...
@section('content')
    <div style="margin-bottom: 2rem;">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <a href="{{ route('logistics.inspection-types.create') }}" class="btn btn-primary">+ Add New Inspection Type</a>
        </div>
    </div>
        ...
        <div class="card-body">
            <form method="GET"
                ...
                <div>
                    ...
                    <a href="{{ route('logistics.inspection-types.index') }}" class="btn btn-secondary"
                    ...
                    @forelse($inspectionTypes as $inspectionType)
                        <tr>
                            ...
                            <td style="display: flex; gap: 0.5rem;">
                                <a href="{{ route('logistics.inspection-types.show', $inspectionType) }}"
                                    class="btn btn-outline" style="padding: 0.25rem 0.5rem; font-size: 0.75rem;">View</a>
                                <a href="{{ route('logistics.inspection-types.edit', $inspectionType) }}"
                                    class="btn btn-success" style="padding: 0.25rem 0.5rem; font-size: 0.75rem;">Edit</a>
                                @if (auth()->user()->isAdmin())
                                    <form action="{{ route('logistics.inspection-types.destroy', $inspectionType) }}"
                    ...
                    @empty
                        <tr>
                            <td colspan="9" style="text-align: center; padding: 2rem; color: #64748b;">
                                No inspection types found. <a href="{{ route('logistics.inspection-types.create') }}"
