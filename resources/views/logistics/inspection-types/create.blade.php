...
@section('title', 'Add New Inspection Type')

@section('content')
    <div style="margin-bottom: 2rem;">
        <h1 style="font-size: 1.875rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">Add New Inspection Type
        </h1>
        <p style="color: #64748b;">Create a new inspection type for customs clearance</p>
    </div>

    <form action="{{ route('logistics.inspection-types.store') }}" method="POST">
        @csrf
        ...
        <div class="card" style="margin-bottom: 1.5rem;">
            ...
            <div class="card-body">
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem;">
                    <div class="form-group">
                        ...
                        <input type="text" name="inspection_code" class="form-input" required
                            value="{{ old('inspection_code') }}" placeholder="e.g., INSP001">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="inspection_name" class="form-input" required
                            value="{{ old('inspection_name') }}" placeholder="Inspection name">
                    ...
                    <div class="form-group">
                        ...
                        <select name="inspection_category" class="form-input" required>
                            ...
                            <option value="Customs" {{ old('inspection_category') == 'Customs' ? 'selected' : '' }}>🛃
                                Customs Clearance</option>
                            <option value="Quality" {{ old('inspection_category') == 'Quality' ? 'selected' : '' }}>✅
                                Quality Control</option>
                            <option value="Safety" {{ old('inspection_category') == 'Safety' ? 'selected' : '' }}>🛡️ Safety
                                Inspection</option>
                            <option value="Environmental"
                                {{ old('inspection_category') == 'Environmental' ? 'selected' : '' }}>🌿 Environmental
                            </option>
                            <option value="Security" {{ old('inspection_category') == 'Security' ? 'selected' : '' }}>🔒
                                Security Check</option>
                            <option value="Health" {{ old('inspection_category') == 'Health' ? 'selected' : '' }}>🏥 Health
                                & Sanitary</option>
                            <option value="Technical" {{ old('inspection_category') == 'Technical' ? 'selected' : '' }}>🔧
                                Technical Inspection</option>
                            <option value="Documentation"
                                {{ old('inspection_category') == 'Documentation' ? 'selected' : '' }}>📋 Documentation
                                Review</option>
                            <option value="Physical" {{ old('inspection_category') == 'Physical' ? 'selected' : '' }}>📦
                                Physical Examination</option>
                            <option value="Laboratory" {{ old('inspection_category') == 'Laboratory' ? 'selected' : '' }}>
                ...
                <div class="form-group" style="margin-top: 1.5rem;">
                    ...
                    <textarea name="description" class="form-input" rows="3" placeholder="Detailed description of the inspection...">{{ old('description') }}</textarea>
                    @error('description')
                        <span class="error-message">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="card-body">
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem;">
                    <div class="form-group">
                        ...
                        <input type="text" name="regulatory_authority" class="form-input"
                            value="{{ old('regulatory_authority') }}" placeholder="e.g., Egypt Customs Authority">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="compliance_standards" class="form-input"
                            value="{{ old('compliance_standards') }}" placeholder="e.g., ISO 9001, WCO Framework">
                ...
                <div class="form-group" style="margin-top: 1.5rem;">
                    <label style="display: flex; align-items: center; gap: 0.5rem;">
                        <input type="checkbox" name="mandatory" value="1" {{ old('mandatory') ? 'checked' : '' }}>
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1.5rem;">
                    <div class="form-group">
                        ...
                        <input type="number" name="estimated_duration" class="form-input" step="0.5" min="0"
                            value="{{ old('estimated_duration') }}" placeholder="e.g., 4.5">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="cost_estimate" class="form-input" step="0.01" min="0"
                            value="{{ old('cost_estimate') }}" placeholder="0.00">
                        @error('cost_estimate')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="validity_period" class="form-input" min="1"
                            value="{{ old('validity_period') }}" placeholder="e.g., 30">
                ...
                <div class="form-group" style="margin-bottom: 1.5rem;">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem;">
                        @php
                            ...
                            $selectedDocuments = old('required_documents', []);
                        @endphp
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <textarea name="prerequisites" class="form-input" rows="3"
                        placeholder="What needs to be completed before this inspection can be performed...">{{ old('prerequisites') }}</textarea>
                    @error('prerequisites')
                        <span class="error-message">{{ $message }}</span>
                    @enderror
                </div>
        ...
        <div style="display: flex; gap: 1rem; justify-content: flex-end;">
            <a href="{{ route('logistics.inspection-types.index') }}" class="btn btn-secondary">Cancel</a>
            <button type="submit" class="btn btn-primary">Create Inspection Type</button>
        </div>
    </form>
@endsection
