...
@section('content')
    <div style="margin-bottom: 2rem;">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <a href="{{ route('logistics.ports.create') }}" class="btn btn-primary">+ Add New Port</a>
        </div>
    </div>
        ...
        <div class="card-body">
            <form method="GET"
                ...
                <div>
                    ...
                    <a href="{{ route('logistics.ports.index') }}" class="btn btn-secondary"
                    ...
                    @forelse($ports as $port)
                        <tr>
                            ...
                            <td style="display: flex; gap: 0.5rem;">
                                <a href="{{ route('logistics.ports.show', $port) }}" class="btn btn-outline"
                                    style="padding: 0.25rem 0.5rem; font-size: 0.75rem;">View</a>
                                <a href="{{ route('logistics.ports.edit', $port) }}" class="btn btn-success"
                                    style="padding: 0.25rem 0.5rem; font-size: 0.75rem;">Edit</a>
                                @if (auth()->user()->isAdmin())
                                    <form action="{{ route('logistics.ports.destroy', $port) }}" method="POST"
                    ...
                    @empty
                        <tr>
                            <td colspan="9" style="text-align: center; padding: 2rem; color: #64748b;">
                                No ports found. <a href="{{ route('logistics.ports.create') }}"
