    ...
    <div style="margin-bottom: 2rem;">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <div style="display: flex; gap: 1rem;">
                <a href="{{ route('logistics.consignee-notify.edit', $consigneeNotify) }}" class="btn btn-primary">Edit
                    Party</a>
                <a href="{{ route('logistics.consignee-notify.index') }}" class="btn btn-secondary">Back to List</a>
            </div>
        </div>
    </div>
