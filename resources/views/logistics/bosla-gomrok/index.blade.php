...
@section('content')
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
        ...
        <a href="{{ route('logistics.bosla-gomrok.create')  ?? '' }}" class="btn btn-primary">+ Add New Bosla</a>
    </div>
        ...
        <div class="card-body">
            <form method="GET"
                ...
                <div>
                    ...
                    <a href="{{ route('logistics.bosla-gomrok.index') ?? ''  }}" class="btn btn-secondary"
                    ...
                    @forelse($boslaItems as $bosla)
                        <tr>
                            ...
                            <td style="display: flex; gap: 0.5rem;">
                                <a href="{{ route('logistics.bosla-gomrok.show' ?? '' , $bosla) }}" class="btn btn-outline"
                                    style="padding: 0.25rem 0.5rem; font-size: 0.75rem;">View</a>
                                <a href="{{ route('logistics.bosla-gomrok.edit' ?? '' , $bosla) }}" class="btn btn-success"
                                    style="padding: 0.25rem 0.5rem; font-size: 0.75rem;">Edit</a>
                                @if (auth()->user() && method_exists(auth()->user(), 'isAdmin') && auth()->user()->isAdmin())
                                    <form action="{{ route('logistics.bosla-gomrok.destroy' ?? '' , $bosla) }}" method="POST"
                    ...
                    @empty
                        <tr>
                            <td colspan="9" style="text-align: center; padding: 2rem; color: #64748b;">
                                No bosla items found. <a href="{{ route('logistics.bosla-gomrok.create') ?? ''  }}"
