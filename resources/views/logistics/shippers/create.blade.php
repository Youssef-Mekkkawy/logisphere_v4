...
@section('content')
    <div style="margin-bottom: 2rem;">
        <h1 style="font-size: 1.875rem; font-weight: 700; color: #1e293b; margin-bottom: 0.5rem;">Add New Shipper</h1>
        <p style="color: #64748b;">Create a new shipper or trading partner</p>
    </div>

    <form action="{{ route('logistics.shippers.store') }}" method="POST">
        @csrf
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem;">
                    <div class="form-group">
                        ...
                        <input type="text" name="shipper_code" class="form-input" required
                            value="{{ old('shipper_code') }}" placeholder="e.g., EG001, US002">
                        @error('shipper_code')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="shipper_name" class="form-input" required
                            value="{{ old('shipper_name') }}" placeholder="Shipper business name">
                        @error('shipper_name')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="company_name" class="form-input" required
                            value="{{ old('company_name') }}" placeholder="Legal company name">
                        @error('company_name')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="shipper_type" class="form-input" required>
                            ...
                            <option value="Manufacturer" {{ old('shipper_type') == 'Manufacturer' ? 'selected' : '' }}>🏭
                                Manufacturer</option>
                            <option value="Exporter" {{ old('shipper_type') == 'Exporter' ? 'selected' : '' }}>📦 Exporter
                            </option>
                            <option value="Trading Company"
                                {{ old('shipper_type') == 'Trading Company' ? 'selected' : '' }}>🏢 Trading Company</option>
                            <option value="Freight Forwarder"
                                {{ old('shipper_type') == 'Freight Forwarder' ? 'selected' : '' }}>🚛 Freight Forwarder
                            </option>
                            <option value="Agent" {{ old('shipper_type') == 'Agent' ? 'selected' : '' }}>👔 Agent</option>
                            <option value="Importer" {{ old('shipper_type') == 'Importer' ? 'selected' : '' }}>📥 Importer
                            </option>
                            <option value="Distributor" {{ old('shipper_type') == 'Distributor' ? 'selected' : '' }}>🏪
                                Distributor</option>
                            <option value="Retailer" {{ old('shipper_type') == 'Retailer' ? 'selected' : '' }}>🛒 Retailer
                            </option>
                        </select>
                        @error('shipper_type')
                            <span class="error-message">{{ $message }}</span>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="business_license" class="form-input"
                            value="{{ old('business_license') }}" placeholder="Business license number">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="established_year" class="form-input" min="1800"
                            max="{{ date('Y') }}" value="{{ old('established_year') }}" placeholder="e.g., 2005">
        ...
        <div class="card" style="margin-bottom: 1.5rem;">
            ...
            <div class="card-body">
                <div class="form-group" style="margin-bottom: 1.5rem;">
                    ...
                    <textarea name="address" class="form-input" rows="3" required placeholder="Complete business address">{{ old('address') }}</textarea>
                    @error('address')
                        <span class="error-message">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1.5rem;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="state_province" class="form-input"
                            value="{{ old('state_province') }}" placeholder="State or province">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="contact_email" class="form-input" required
                            value="{{ old('contact_email') }}" placeholder="contact@company.com">
                        @error('contact_email')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="alternative_phone" class="form-input"
                            value="{{ old('alternative_phone') }}" placeholder="+20 1234 567891">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="emergency_contact" class="form-input"
                            value="{{ old('emergency_contact') }}" placeholder="Name - Phone">
            ...
            <div class="card-body">
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem;">
                    <div class="form-group">
                        ...
                        <input type="text" name="industry_type" class="form-input"
                            value="{{ old('industry_type') }}" placeholder="e.g., Manufacturing, Agriculture">
                        @error('industry_type')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="annual_volume" class="form-input" min="0"
                            value="{{ old('annual_volume') }}" placeholder="e.g., 5000">
                        @error('annual_volume')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="operating_hours" class="form-input"
                            value="{{ old('operating_hours') }}" placeholder="e.g., Mon-Fri 8AM-6PM">
                ...
                <div class="form-group" style="margin-top: 1.5rem;">
                    ...
                    <textarea name="specialization" class="form-input" rows="3"
                        placeholder="Describe what this shipper specializes in">{{ old('specialization') }}</textarea>
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1.5rem;">
                    <div class="form-group">
                        ...
                        <select name="credit_rating" class="form-input">
                            ...
                            <option value="A+" {{ old('credit_rating') == 'A+' ? 'selected' : '' }}>A+ (Excellent)
                            </option>
                            <option value="A" {{ old('credit_rating') == 'A' ? 'selected' : '' }}>A (Very Good)
                            </option>
                            <option value="A-" {{ old('credit_rating') == 'A-' ? 'selected' : '' }}>A- (Good)</option>
                            <option value="B+" {{ old('credit_rating') == 'B+' ? 'selected' : '' }}>B+ (Fair)</option>
                            <option value="B" {{ old('credit_rating') == 'B' ? 'selected' : '' }}>B (Fair)</option>
                            <option value="B-" {{ old('credit_rating') == 'B-' ? 'selected' : '' }}>B- (Poor)</option>
                            <option value="C+" {{ old('credit_rating') == 'C+' ? 'selected' : '' }}>C+ (Poor)</option>
                            <option value="C" {{ old('credit_rating') == 'C' ? 'selected' : '' }}>C (Very Poor)
                            </option>
                            <option value="C-" {{ old('credit_rating') == 'C-' ? 'selected' : '' }}>C- (Unacceptable)
                            </option>
                        </select>
                        @error('credit_rating')
                            <span class="error-message">{{ $message }}</span>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="payment_terms" class="form-input"
                            value="{{ old('payment_terms', 'Net 30') }}" placeholder="e.g., Net 30, Net 15">
                        @error('payment_terms')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="credit_limit" class="form-input" step="0.01" min="0"
                            value="{{ old('credit_limit') }}" placeholder="e.g., 100000">
                        @error('credit_limit')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="currency_preference" class="form-input">
                            <option value="USD" {{ old('currency_preference', 'USD') == 'USD' ? 'selected' : '' }}>USD
                            </option>
                            <option value="EUR" {{ old('currency_preference') == 'EUR' ? 'selected' : '' }}>EUR
                            </option>
                            <option value="GBP" {{ old('currency_preference') == 'GBP' ? 'selected' : '' }}>GBP
                            </option>
                            <option value="EGP" {{ old('currency_preference') == 'EGP' ? 'selected' : '' }}>EGP
                            </option>
                            <option value="AED" {{ old('currency_preference') == 'AED' ? 'selected' : '' }}>AED
                            </option>
                            <option value="CNY" {{ old('currency_preference') == 'CNY' ? 'selected' : '' }}>CNY
                            </option>
                        </select>
                ...
                <div class="form-group" style="margin-bottom: 1.5rem;">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem;">
                        @php
                            ...
                            $selectedCargoTypes = old('cargo_types', []);
                        @endphp
                ...
                <div class="form-group">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem;">
                        @php
                            ...
                            $selectedServices = old('services_offered', []);
                        @endphp
        ...
        <div class="card" style="margin-bottom: 1.5rem;">
            ...
            <div class="card-body">
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem;">
                    <div class="form-group">
                        ...
                        <input type="text" name="sales_representative" class="form-input"
                            value="{{ old('sales_representative') }}" placeholder="Assigned sales rep">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="account_manager" class="form-input"
                            value="{{ old('account_manager') }}" placeholder="Assigned account manager">
                ...
                <div class="form-group" style="margin-top: 1.5rem;">
                    ...
                    <textarea name="notes" class="form-input" rows="4" placeholder="Additional notes about this shipper">{{ old('notes') }}</textarea>
                    @error('notes')
                        <span class="error-message">{{ $message }}</span>
                    @enderror
                </div>
        ...
        <div style="display: flex; gap: 1rem; justify-content: flex-end;">
            <a href="{{ route('logistics.shippers.index') }}" class="btn btn-secondary">Cancel</a>
