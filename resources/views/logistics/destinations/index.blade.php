...
@section('content')
    <div style="margin-bottom: 2rem;">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <a href="{{ route('logistics.destinations.create') }}" class="btn btn-primary">+ Add New Destination</a>
        </div>
    </div>
        ...
        <div class="card-body">
            <form method="GET"
                ...
                <div>
                    ...
                    <a href="{{ route('logistics.destinations.index') }}" class="btn btn-secondary"
                    ...
                    @forelse($destinations as $destination)
                        <tr>
                            ...
                            <td style="display: flex; gap: 0.5rem;">
                                <a href="{{ route('logistics.destinations.show', $destination) }}" class="btn btn-outline"
                                    style="padding: 0.25rem 0.5rem; font-size: 0.75rem;">View</a>
                                <a href="{{ route('logistics.destinations.edit', $destination) }}" class="btn btn-success"
                                    style="padding: 0.25rem 0.5rem; font-size: 0.75rem;">Edit</a>
                                @if (auth()->user()->isAdmin())
                                    <form action="{{ route('logistics.destinations.destroy', $destination) }}" method="POST"
                    ...
                    @empty
                        <tr>
                            <td colspan="8" style="text-align: center; padding: 2rem; color: #64748b;">
                                No destinations found. <a href="{{ route('logistics.destinations.create') }}"
